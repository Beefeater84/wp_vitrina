...
<div id="content" class="content" role="main">
 ...
 <p>Что такое переменная $cat? Откуда она берется</p>

<section>
	<p>Выводит все подкатегории с глубиной 1 от заданный категории</p>
	<p>Вопрос на строке 38</p>
	<p>Вопрос на строке 42</p>
	...
	function child_term($arg, $cur_cat){
		...
		$dochernii_kategorii = get_categories('child_of=' . $kat . '&hide_empty=0');
				// Как вывести Путь до категории, у которой ID = $kat? Лучше не через if. У нас ведь уже есть  $dochernii_kategorii, вот нужно вывести Slug той, у которой ID = 30 
...
<section>
<p>Выводит все подкатегории родительской категории. С полной глубиной</p>
<?php	
	 $category = get_the_category();
	 $this_category = get_category($cat); // получаем id текущей категории
